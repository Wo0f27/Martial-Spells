...
- dependency-native one-handed instant-release animation and translated local release particles;
...
3. For about 2 seconds, verify Movement Speed and Knockback Resistance each gain +50% of their base value.

...
public final class MartialNetwork {
    ...
    public static void register() {
         ...
         * Mutilate animation.
         *
         * Mutilate is an instant spell, so its authored melee pose is
         * explicitly synchronized instead of relying only on Iron's generic
         * instant-spell finish-animation callback.
         */
        instance.messageBuilder(
                ...
                .decoder(
                        SyncMutilateAnimationPacket::new
                )
                .encoder(
                        SyncMutilateAnimationPacket::toBytes
                )
                .consumerMainThread(
                        SyncMutilateAnimationPacket::handle
                )
                .add();

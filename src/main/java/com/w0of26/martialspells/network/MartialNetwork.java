...
public final class MartialNetwork {
    ...
    public static void register() {
        ...
        instance.messageBuilder(
                        SyncBearTrapAnimationPacket.class,
                        nextPacketId(),
                        NetworkDirection.PLAY_TO_CLIENT
                )
                .decoder(SyncBearTrapAnimationPacket::new)
                .encoder(SyncBearTrapAnimationPacket::toBytes)
                .consumerMainThread(SyncBearTrapAnimationPacket::handle)
                .add();
    ...
    public static <MSG> void sendToServer(MSG message) {
        if (instance == null) {
            throw new IllegalStateException("Martial Spells network has not been registered.");
        }
    ...
    /** Sends a packet to the target player and all tracking clients. */
    ...
    /** Sends a packet to every client tracking an entity and to the entity itself when applicable. */
